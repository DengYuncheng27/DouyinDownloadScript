...
//###################################修改区域###################################
var filepath='E:/filedown/douyinFile';                    //视频保存目录，提前创建，确保已存在。
...
setInterval(function(){
    ...
    $('.OFZHdvpl').children().each(function(){
        ccc = "true";
        var cls2= $(this).attr("class");
        if (cls2=="OFZHdvpl DownloadURL"){
            ccc = "false";
            return false;
        };
    });
    ...
    //插入下载按钮
    if (ccc=="true"){
        $('.OFZHdvpl').children().each(function(index,element){
            if(index==0){
                $(this).before('<div class="OFZHdvpl DownloadURL" onclick="download3();download4()"><svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" class="u1O5vnab eclJUOOC" viewBox="0 0 36 36"><path d="M23 14l-8 8-8-8h5v-12h6v12zM15 22h-15v8h30v-8h-15zM28 26h-4v-2h4v2z"></path></svg><span class="Uehud9DZ">下载</span></div>');
                return false;
            };
        });
    };    
